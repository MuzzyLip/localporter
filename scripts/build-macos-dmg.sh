...
RELEASE_VERSION="${LOCALPORTER_RELEASE_VERSION:-$APP_VERSION}"
DMG_NAME="${APP_NAME}-${RELEASE_VERSION}-macos-universal.dmg"
DMG_DIR="$UNIVERSAL_BUILD_DIR/bundle/dmg"
DMG_PATH="$DMG_DIR/$DMG_NAME"
STAGING_DIR="$UNIVERSAL_BUILD_DIR/dmg-staging"
RW_DMG_PATH="$DMG_DIR/${APP_NAME}-${RELEASE_VERSION}-macos-universal.rw.dmg"
